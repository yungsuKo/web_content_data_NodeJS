...
function _crawler_naverPost() {
  _crawler_naverPost = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var delay, timestamp, browser, page, content, $, $postLists, list;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            _context.next = 15;
            return page["goto"]("https://post.naver.com/my.naver?memberNo=202156");
          ...
          case 21:
            ...
            $postLists.each(function (i, elem) {
              ...
              list[i] = new PostData({
                ...
                views: $(this).find("span.view_post").text().split(" ")[0].replace(",", ""),
            ...
            _context.prev = 27;
            _context.next = 30;
            return PostData.insertMany(list);
