...
exports.postDataListController = exports.getDataListController = exports.dataDetailController = void 0;

require("../db");

var _AccountUrl = _interopRequireDefault(require("../models/AccountUrl"));
...
var getDataListController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var crawlUrl, dataList;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            crawlUrl = req.body.crawlUrl;
            _context.next = 4;
  ...
  return function getDataListController(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.getDataListController = getDataListController;

var postDataListController = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, crawlUrl, accountName, dataList, isnaver, exist, url, urlList, i;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _req$body = req.body, crawlUrl = _req$body.crawlUrl, accountName = _req$body.accountName;
            _context2.next = 4;
            return _AccountUrl["default"].find({});
          ...
          case 4:
            ...
            return _context2.abrupt("return", res.render("list_data", {
              title: "List Data",
          ...
          case 7:
            _context2.next = 9;
            return crawlUrl.includes("https://post.naver.com/");

          case 9:
            isnaver = _context2.sent;
            _context2.next = 12;
            return _AccountUrl["default"].exists({
              url: crawlUrl
            });
          ...
          case 25:
            console.log(url); // postUrlCrawl1 : 신규 계정이 최초 입력되었을 때, 크롤링해야하는 글 목록이 크롤링됨

            _context2.next = 28;
            return (0, _postUrlCrawler["default"])(url);

          case 28:
            urlList = _context2.sent;
            i = 0;
  ...
  return function postDataListController(_x3, _x4) {
...
exports.dataDetailController = dataDetailController;