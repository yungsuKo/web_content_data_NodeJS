...
exports.dayDataController = void 0;
...
var dayDataController = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var getResultObject, _req$query, id, startDate, endDate, accounturl, postUrls, semiResults, result, i, semiResult, data;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            getResultObject = /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(arrItem) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return _context.abrupt("return", resultObject);
              ...
              return function getResultObject(_x3) {
            ...
            _req$query = req.query, id = _req$query.id, startDate = _req$query.startDate, endDate = _req$query.endDate;
            console.log(id, startDate, endDate);
            _context2.next = 6;
            return _AccountUrl["default"].findById(id);

          case 6:
            accounturl = _context2.sent;
            postUrls = [];
            _context2.next = 10;
            return _CrawlUrlPost["default"].find({
              ...
              uploadTime: -1
            }).lean().populate("postDetails");

          case 10:
            postUrls = _context2.sent;
  ...
  return function dayDataController(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.dayDataController = dayDataController;